    ...
    <nav role="navigation" class="navbar-default navbar-static-side">
        <div class="sidebar-collapse">
            <ul id="side-menu" class="nav metismenu">
                <li class="nav-header">
                    <div class="dropdown profile-element"><span><img alt="image" src="/static/img/avanade.png"
                ...
                <li>
                    ...
                    <router-link :to="{name : 'Vacancies'}">
                        <i class="fa fa-bullhorn"></i> <span class="nav-label">Vagas</span>
                    </router-link>
                </li>
                <li>
                    
                    <router-link :to="{name : 'Candidates'}">
                        <i class="fa fa-diamond"></i> <span class="nav-label">Candidatos</span>
                    </router-link>
                </li>
